		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GPSapp",
									"targetURL": "#arcgisjssapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"arcgisjssapui5-display": {
								"semanticObject": "arcgisjssapui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=arcgisjssapui5",
									"url": sap.ui.require.toUrl("arcgisjssapui5")
								}
							}
						}
					}
